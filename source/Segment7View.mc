...
class Segment7View extends WatchUi.WatchFace {
    ...
    hidden function setColorTheme() as Void {
        ...
        if(canBurnIn) {
            ...
            if(propTheme == 2)  { themeColors = [0x000000, 0x254c2d, 0x152b19, 0x8fe09e, 0xbff3d3, 0xfbcb77, 0x222222, 0x3fde65, 0xFF0000]; } // Green
            ...
            if(propTheme == 8)  { themeColors = [0x000000, 0xAA0000, 0xAA0000, 0xFFFFFF, 0xFFFFFF, 0xFF0000, 0x222222, 0x00FF00, 0xFF0000]; } // White on Red
            if(propTheme == 9)  { themeColors = [0x000000, 0x00AAAA, 0x005555, 0xFFFFFF, 0xFFFFFF, 0xFFFF00, 0x222222, 0x00FF00, 0xFF0000]; } // White on Turquoise
        }
    }
